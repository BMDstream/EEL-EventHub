...
def get_event_email_config(event: Event, session: Session):
    ...
    if client:
        config = {
            ...
            "font_family": getattr(client, "font_family", "'Fluent Calibri', Calibri, Candara, sans-serif") or "'Fluent Calibri', Calibri, Candara, sans-serif",
    ...
    if not config.get("font_family"):
        config["font_family"] = "'Fluent Calibri', Calibri, Candara, sans-serif"
