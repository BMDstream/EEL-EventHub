...
def get_event_email_config(event: Event, session: Session):
    ...
    if client:
        config = {
            ...
            "font_family": getattr(client, "font_family", "'Fluent Calibri', Georgia, Cambria, 'Times New Roman', Times, serif") or "'Fluent Calibri', Georgia, Cambria, 'Times New Roman', Times, serif",
    ...
    if not config.get("font_family"):
        config["font_family"] = "'Fluent Calibri', Georgia, Cambria, 'Times New Roman', Times, serif"
