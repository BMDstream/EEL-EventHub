...
def get_logo_html(config: Optional[dict], meta: dict, primary_color: str) -> str:
    ...
    if show_logo:
        ...
        font_family = "'Fluent Calibri', Georgia, Cambria, 'Times New Roman', Times, serif"
        if config and isinstance(config, dict):
            font_family = config.get("font_family", "'Fluent Calibri', Georgia, Cambria, 'Times New Roman', Times, serif")
        return f"""
