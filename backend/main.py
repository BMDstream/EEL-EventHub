...
from backend.routers import auth, events, registrations, settings, users, webhooks, tasks, tournament, media, security, reminders
...
app.include_router(reminders.router, prefix="/api/py", tags=["reminders"])
